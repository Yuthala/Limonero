...
<body>
	<header class="header">
		<div class="container">
			...
			<h3 class="subheader__text">Предлагаем несколько вариантов сотрудничества</h3>
		</div>
	...
	<main>
			...
			<div class="container">
				...
				<div class="services__inner">
					...
					<div class="services__item">
						...
						<p class="services__text">Проконсультируем по любым вопросам, связанным с изготовлением вязаного трикотажа. <br>По материалам, узорам, конструированию, расходу пряжи, поставщикам, обучению.</p>
		...
		<section class="slider">
			...
			<h2 class="slider__title title" id="portfolio">примеры работ</h2>
			<div class="wrap">
			...
			<div class="container">
				...
				<div class="advantages__inner">
					...
					<div class="advantages__item">
						...
						<h3 class="advantages__text">Официально. Работаем с физлицами,<br>юрлицами, ИП</h3>
					</div>
				</div>
			</div>
		</section>
		...
		<section class="about" id="about">
			<div class="container">
				...
				<div class="about__inner">
					...
					<p class="about__text">Привет! Мастера трикотажной мастерской Limonero имеют большой опыт конструирования и изготовления женских, мужских и детских трикотажных изделий с использованием вязальных машин. Наша цель - помочь предпринимателям, которые хотят расширить свой ассортимент трикотажа, но при этом не вкладываться в производство крупных партий. Трикотажные фабрики редко работают с партиями менее 100 единиц одного артикула, но иногда нужно гораздо меньше. Это может быть лимитированная сезонная коллекция, изделия для небольшого магазина, небольшая партия для определенного мероприятия.<br><br>
					В мастерской также можно заказать расчет трикотажного изделия для изготовления на другом производстве или самостоятельного изготовления. Сделаем все расчеты, схемы, описание, подберем пряжу и отвяжем образцовое изделие. Для промышленного производства эти материалы передаются на трикотажную фабрику, и по ним специалисты фабрики составляют программу для промышленной вязальной машины. <br><br>Мы открыты вашим идеям, и наши мастера могут дать им экспертную оценку модели с точки зрения материала, конструкции и технологии изготовления изделия.<br>
					...
					У нас собственная мастерская и оборудование: вязальная и кеттельная машины, гладильное оборудование, швейное оборудование.<br><br>
					Трикотажное производство - это и еще много расчетов. Используем современное программное обеспечение и компьютерное оборудование, которые позволяют оцифровывать узоры, составлять многоцветные схемы в цифровом формате, делать автоматический расчет кривых и многое другое.
				</div>
			</div>
		</section>
