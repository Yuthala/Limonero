	...
	<main>
		...
		<section class="design" id="design">
			<div class="container">
				...
				<p>Мы предлагаем полный цикл разработки трикотажного изделия на один или несколько размеров. В результате вы получаете всё необходимое для запуска изделия в серийное производство под своей торговой маркой. Можем взять на себя производство небольших партий.</p>
				<ul>Услуга включает в себя: 
					<li>составления технического задания</li>
				...
				<p>Примерная стоимость комплексной услуги приведена ниже.</p>
			</div>
		</section>
	</main>
