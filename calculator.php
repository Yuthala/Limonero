	...
	<main>
		<section class="machine-knit">
			<div class="container">
				...
				<p>В зависимости от состава пряжи, выбранной вязки, плотности вязания, желаемой толщины полотна, особенностей конкретной модели расход пряжи может отличаться как в большую, так и в меньшую сторону. Ажурные вставки, сложные резинки, узоры увеличивают стоимость изготовления, наценка рассчитывается индивидуально.</p>
