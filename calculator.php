	...
	<main>
		<section class="machine-knit" id="machine-knit">
			<div class="container">
				...
				<p>Стоимость изготовления рассчитывается по метражу расхода пряжи - 2 рубля/метр. Вяжу по вашим описаниям или составлю описание для вас (услуга оплачивается отдельно, подробнее в разделе <a href="#design" class="calculator-link">Разработка модели</a> ).</p>
		...
		<section class="design" id="design">
			<div class="design-inner container">
				...
				<p>Я предлагаю комплексную услугу разработки трикотажного изделия на один или несколько размеров, включая отвязывание образцового изделия. В результате вы получаете всё необходимое для запуска модели в серийное производство под своей торговой маркой. Могу взять на себя производство небольших партий (подробнее в разделе <a href="#machine-knit" class="calculator-link">Машинное вязание</a> ).</p>
