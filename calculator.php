...
<body>
	...
	<main>
		...
		<section class="design" id="design">
			<div class="design-inner container calculator">
				<h2 class="design__header">Разработка модели</h2>
				<p>Я предлагаю услугу разработки трикотажного изделия на один или несколько размеров с изготовлением образцового изделия. <strong>Отвязка 1 образца изделия <u>включена в стоимость!</u></strong> В результате вы получаете всё необходимое для запуска модели в серийное производство под своей торговой маркой. Могу взять на себя производство небольших партий (подробнее в разделе <a href="#machine-knit" class="calculator-link">Машинное вязание</a> ).</p>
