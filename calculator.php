	...
	<main>
		<section class="machine-knit" id="machine-knit">
			<div class="container">
				...
				<p>Стоимость изготовления рассчитывается по метражу расхода пряжи - 2 рубля/метр. Вяжем по вашим описаниям или составим описание для вас (услуга оплачивается отдельно, подробнее в разделе <a href="#design" class="calculator-link">Разработка модели</a> ).</p>
