...
'use strict';
	...
	const items = [
		...
		new Item ("Рукав, 2 шт.", 2500, 'img/calculator/image_101.webp'),
		new Item ("Капюшон", 3000, 'img/calculator/image_102.webp'),
		new Item ("Шнур вязаный, 1 м", 300, 'img/slider/slide_5.webp'),
		new Item ("Воротник для бомбера", 1200, 'img/calculator/image_104.webp'),
		new Item ("Накладной карман", 300, 'img/calculator/image_105.webp')
	];
